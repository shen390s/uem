(deftheme rshen-x3840
  "Created 2019-12-21.")

(custom-theme-set-faces
 'rshen-x3840
 '(default ((t (:family "Inconsolata LGC" :foundry "nil" :width normal :height 210 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#ffffff" :background "#002451" :stipple nil :inherit nil))))
